=== Applicant Stack Jobs Display ===
Contributors: jdm-labs
Tags: Applicant Stack, ATS, Jobs Display
Requires at least: 4.5
Tested up to: 5.0.3
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

A custom plugin which displays a responsive list of jobs from Applicant Stack using their JSON API.
